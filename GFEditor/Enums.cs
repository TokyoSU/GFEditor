namespace GFEditor
{
    ...
    public enum EEffectCommand
    {
        ...
        HP,
        HPEX,
        MP, // minAmount, maxAmount, minPercent, maxPercent
        AttrMaxHP,
        AttrMaxMP,
        AttrDefence,
        AttrPhysicoDamage,
        ...
        AttrCriticalRate,
        AttrCriticalDamage,
        AttrMagicCriticalRate,
        AttrMagicCriticalDamage,
        AttrRecoverHP,
        AttrRecoverMP,
        SpellBreak,
        EnchantCancel,
        ...
        ReviveBuff,
        Assemble,
        SetMigrationInvincible,
        SetReviveParas,
        SetMonsterInvincible,
        Damage2HP,
        MPDamage2MP,
        AttrCastFailRate,
        Regenerate,
        ...
        EnchantKillsRandom,
        DamageAdd,
        AttrBanGainSpellType,
        AttrSpellDamage,
        AttrSpellDamageRate,
        AttrSpellDuration,
        AttrSpellChangeEffectID,
        AttrRangeHitRate,
        AttrShield,
        AttrWeaponDamage,
        AttrWeaponCriticalDamage,
        AttrWeaponCriticalRate,
        AttrWeaponAttackSpeedRate,
        AttrWeaponDamageRate,
        AttrHate,
        SummonInEventArea,
        ItemTriggerEvent,
        Damage2MP,
        AttrHitRateRate,
        AttrRangeHitRateRate,
        AttrDodgeRateRate,
        ResistDamage,
        SpecialDamage,
        SummonPet,
        ...
        AttrForm,
        MobChangeAI,
        ElfFamiliarEnergyMood,
        ElfFamiliarEnergyMoodRate,
        DelayOutBattle,
        MPCombo,
        UseTwoWeapon,
        FakeDie,
        ...
        AttrWeaponEQTypeModMagicDamageRate,
        AttrWeaponMagicCriticalRate,
        AttrWeaponMagicCriticalDamage,
        ...
        AddCharNum,
        AddRainbowCount,
        OnAttackBuffPhyCritical,
        OnAttackBuffMagicCritical,
        OnAttackBuffDodge,
        OnAttackBuffBlock,
        OnAttackBuffBePhyCritical,
        OnAttackBuffBeMagicCritical,
        AttrGainCollectItem,
        AttrBase,
        BornNPC,
        BindEnchant,
        ...
        AttrRateBonus,
        AllElfBonus,
        AttrAttackPenetration,
        DamageReversePenetration,
        ...
        SitChair,
        SetCoRideAction,
        ElfTravelCombineRate,
        GetExpiredDailyAward,
        AttrEnhanceByClassType,
        ...
        IndexCasterAbility,
        AttrSpellSetDamage,
        AttrSpellSetDamageRate,
        AttrSpellSetDuration,
        AttrSpellSetChangeEffectID,
        ChangeSpellSetSpecificSpell,
        SpellSetCoolDown,
        SpellSetGroupCoolDown,
        ReplaceShortcutPage,
        AddNodeTempleChallengeTime,
        SpellEffect,
        SpellGroupEffect
    };
}
